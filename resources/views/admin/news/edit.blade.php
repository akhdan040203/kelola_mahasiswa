...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Berita</h2>
        <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Update informasi berita</p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                @if($news->image)
                <div class="mb-4">
                    <p class="text-xs text-gray-600 dark:text-gray-400 mb-2">Gambar saat ini:</p>
                    <img src="{{ asset($news->image) }}" alt="Current" class="max-w-full h-48 rounded-lg border-2 border-gray-300 object-cover">
                </div>
                @endif

                <!-- Preview Container -->
                <div id="imagePreviewContainer" class="hidden mb-4">
                    <p class="text-xs text-gray-600 dark:text-gray-400 mb-2">Preview gambar baru:</p>
                    <div class="relative inline-block">
                        <img id="imagePreview" src="" alt="Preview" class="max-w-full h-64 rounded-lg border-2 border-green-500 object-cover">
                    ...
                    <p class="text-xs text-gray-500 mt-2">Klik tombol X untuk membatalkan perubahan gambar</p>
                </div>
                ...
                <div class="flex items-center gap-4">
                    <label for="image" class="cursor-pointer inline-flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition">
                        ...
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300">
                            {{ $news->image ? 'Ganti Gambar' : 'Pilih Gambar' }}
                        </span>
                    </label>
